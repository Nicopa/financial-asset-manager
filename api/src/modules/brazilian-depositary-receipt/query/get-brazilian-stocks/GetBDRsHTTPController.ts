...
export class GetBDRsHTTPController extends HTTPController {
	constructor(
		private readonly query: Query<undefined, GetBDRsResponseModel>,
		private readonly presenter: HTTPPresenter<GetBDRsResponseModel>,
	) {
		super();
	}
