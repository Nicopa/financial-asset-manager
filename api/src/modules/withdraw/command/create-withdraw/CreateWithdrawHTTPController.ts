...
import {
	...
	CreateWithdrawResponseModel,
} from "./CreateWithdraw";

export class CreateWithdrawHTTPController extends HTTPController {
	constructor(
		private readonly command: Command<
			CreateWithdrawRequestModel,
			CreateWithdrawResponseModel
		>,
		private readonly presenter: HTTPPresenter<CreateWithdrawResponseModel>,
	) {
		super();
	}
	private getRequestModel(request: HTTPRequest): CreateWithdrawRequestModel {
